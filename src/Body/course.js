...
import Course1 from "../ui/kotlin.png";
...
function CoursePage(props){
    ...
    const [course, setCourse] = useState(
        {
            ID: 1,
            title: "Develop Android apps with Kotlin in 120 minutes",
            about: "In this course i'll teach you how to Write better Android apps faster with Kotlin. Kotlin is a modern statically typed programming language used by over 60% of professional Android developers that helps boost productivity, developer satisfaction, and code safety.. We're gonna study a lot of cases here, setting your work panel, makingg some awesome actions and presets for future.<br />Hope you'll get some really usefull stuff out of this course. Good Luck to all!",
            tutor: {
                ID: 1,
                ...
                <div className="extras-block rel flex">
                    ...
                    <div className="now-watching rel">
                        ...
                        <div className="section section-b rel">                    
                            ...
                            <div className="tooltip abs s13 fontb">86 Live Now</div>
                            <div className="you-list rel">
                                <div className="you rel aic flex">
                                    ...
                                    <div className="meta rel">
                                        <h2 className="s15 name fontb c333">Abhinatha Ghimire</h2>
                                        <h2 className="s13 uname fontn c777">@Abhinatha</h2>
                                    </div>
                                </div>
                                <div className="you rel aic flex">
                                    <div className="pic">
                                    ...
                                    <div className="meta rel">
                                        <h2 className="s15 name fontb c333">Kisor Rana</h2>
                                        <h2 className="s13 uname fontn c777">@Kisor</h2>
                                    </div>
                                </div>
                                <div className="you rel aic flex">
                                    <div className="pic">
                                    ...
                                    <div className="meta rel">
                                        <h2 className="s15 name fontb c333">Abhishek Shrestha</h2>
                                        <h2 className="s13 uname fontn c777">@Abhishek</h2>
                                    </div>
                                </div>
                                <div className="you rel aic flex">
                                    <div className="pic">
                                    ...
                                    <div className="meta rel">
                                        <h2 className="s15 name fontb c333">Guneet Tuladhar</h2>
                                        <h2 className="s13 uname fontn c777">@Guneet</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
