...
class IOT extends Component{
    ...
    componentDidMount() {
        axios.get("http://localhost:90/course/IOT", this.state.config)
            .then((response) => {
    ...
    render() {
        ...
        return (
            <div style={{ backgroundColor: "#ffffff87" }}>
                <section>
                    <img class="waver" src="https://www.pngitem.com/pimgs/m/360-3600842_internet-of-things-iot-device-icon-transparent-hd.png" alt="wave" />
                    <div class="container">
                        <div class="row">
                            <div class="col-12" style={{ marginTop: "18px" }}>
                                <div class="section-head col-sm-12" style={{ backgroundColor: "rgb(0 0 0 / 88%)", color: "white", marginBottom: "0rem" }}>
                                    <h4><span style={{ color: "white" }}>Internet of</span> Things</h4>
                                    <p style={{ color: "white" }}>The Internet of Things, or "IoT" for short, is about extending the power of the internet beyond computers and smartphones
                                <br class="d-lg-block d-none" /> to a whole range of other things, processes, and environments.</p>
                                </div>
                                <hr />
                            </div>
                        </div>
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    <span class="badge badge-pill badge-success"> <i class="fa fa-globe"></i> Internet of Things</span>
                                                </p>
                                                <p class="card-text">
